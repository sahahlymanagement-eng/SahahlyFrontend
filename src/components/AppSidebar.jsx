...
import { FiMenu, FiX, FiChevronRight, FiLogOut, FiLayers } from "react-icons/fi";
...
export default function AppSidebar({
  ...
  const accountLabel = roleSubtitle || `${roleTitle} account`;
          ...
          {!collapsed && (
            <div className="ast-brand-lockup">
              ...
              <div>
                ...
                <span className="ast-brand-role">{roleTitle}</span>
              </div>
            </div>
          )}
          <button
        ...
        {!collapsed ? (
          <div className="ast-user-card">
            ...
            <div className="ast-user-info">
              ...
              <span className="ast-user-role">{accountLabel}</span>
            </div>
          </div>
        ) : (
