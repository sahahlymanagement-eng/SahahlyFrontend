...
export default defineConfig({
  ...
  server: { proxy: { "/api/drpeter-indexing": { target: process.env.DR_PETER_INDEXING_API_TARGET || "http://localhost:6001", changeOrigin: true, timeout: 180000, proxyTimeout: 180000 } } },
